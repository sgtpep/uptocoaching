...
<link href="${options.page}" hreflang="en" rel="alternate">
<link href="ru/${options.page}" hreflang="ru" rel="alternate">
<link href="${options.root}${options.page}" rel="canonical">
<link href="images/favicon.png" rel="icon">
<meta charset="utf-8">
<meta content="${options.meta.description ||
  (options.russian
    ? 'Коучинг с профессиональным коучем Ксенией Романовой.'
    : 'Coaching with a professional coach Ksenia Romanova.')}" name="description">
