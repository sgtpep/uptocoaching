...
<meta content="%ABSOLUTE_BASE%images/og-image.jpg" property="og:image">
...
<meta content="${description.replace(/\.$/, '')}" property="og:title">
...
<nav class="header">
  <div>
  ...
  }"><img alt="${options.name}" src="images/logo.png"></a>
    ...
    options.root
      ...
      <li class="scripted"><a href="${options.root}.#contacts">${
    options.russian ? 'Контакты' : 'Contacts'
  }</a></li>
      <!--<li class="scripted"><a class="${
